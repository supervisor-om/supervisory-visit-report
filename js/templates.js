        const defaultSchoolVisitTypesData = {
            ...
            'private_exploratory': {
                ...
                objectives: [
                    ...
                    '3- متابعة موافقات التعيين واسم [المعلمين/المعلم/المعلمات/المعلمة] [وإدراجهم/وإدراجه/وإدراجهن/وإدراجها] في البوابة التعليمية.',
                    '4- متابعة توفر الأدلة وكتاب الطالب وتحديثها.',
                    '5- متابعة توزيع الجدول ونصاب الحصص [للمعلمين/للمعلم/للمعلمات/للمعلمة].',
                    '6- متابعة الملاعب وتخطيطها والأدوات الرياضية.',
                    '7- متابعة النشرات ووثائق التقويم ومناقشة مستجداتها.',
                    '8- متابعة المنهاج وسجلات [المعلمين/المعلم/المعلمات/المعلمة].'
                ]
            },
            'supervisory': {
                name: 'زيارة إشرافية',
