        const defaultSchoolVisitTypesData = {
            ...
            'private_exploratory': {
                ...
                objectives: [
                    '1- مقابلة [الفاضل/الفاضل/الفاضلة/الفاضلة] [مدير/مدير/مديرة/مديرة] المدرسة و[معلمي/معلم/معلمات/معلمة] الرياضة المدرسية.',
                    '2- حضور الطابور المدرسي.',
                    '3- تحديث قاعدة بيانات [المعلمين/المعلم/المعلمات/المعلمة].',
                    '4- متابعة موافقات التعيين واسم [المعلمين/المعلم/المعلمات/المعلمة] [وإدراجهم/وإدراجه/وإدراجهن/وإدراجها] في البوابة التعليمية.',
                    '5- متابعة توفر الأدلة وكتاب الطالب وتحديثها.',
                    '6- متابعة توزيع الجدول ونصاب الحصص [للمعلمين/للمعلم/للمعلمات/للمعلمة].',
                    '7- متابعة الملاعب وتخطيطها والأدوات الرياضية.',
                    '8- متابعة النشرات ووثائق التقويم ومناقشة مستجداتها.',
                    '9- متابعة المنهاج وسجلات [المعلمين/المعلم/المعلمات/المعلمة].'
                ]
            },
            'supervisory': {
                name: 'زيارة إشرافية',
            ...
            'local_inspection': {
                name: 'زيارة إشرافية (فحص محلي)',
                objectives: [
                    '1- الالتقاء ب[الفاضل/الفاضل/الفاضلة/الفاضلة] [مدير/مدير/مديرة/مديرة] المدرسة و[معلمي/معلم/معلمات/معلمة] الرياضة المدرسية.',
                    '2- متابعة درجات قياسات الأداء العملي.',
                    '3- متابعة الاختبارات القصيرة للصفوف (11-12).',
                    '4- متابعة درجات الزي.',
                    '5- متابعة درجات (الزي+الملاحظة).'
                ]
            }
        };
        ...
        // جدول التقييم كما في استمارة الزيارة الإشرافية الرسميّة (2026/2027) — للتصدير وحده.
        // تصنيف المجال/المعيار فيها يخالف evaluationItems (مهارات التعلم تحت «النمو الشخصي»،
        // وتخطيط المنهاج وإدارة الصف تحت «مناخ المدرسة»، وبنود القيادة والحوكمة بمعايير
        // «القيادة/الحوكمة»)، لكنّ evaluationItems يقود شاشة التقييم وعناوين النقاط في النصوص
        // المولَّدة («• مبادرات: …») فلا يُمسّ هنا. الترتيب والأرقام واحدةٌ في الاثنين.
        const officialFormItems = [
            { id: 1,  domain: 'الإنجاز الدراسي',              standard: 'التحصيل الدراسي',        title: 'تحصيل الطلبة في الأعمال الصفية وغير الصفية.' },
            { id: 2,  domain: 'الإنجاز الدراسي',              standard: 'التقدم الدراسي',         title: 'التقدم الدراسي للطلبة بما فيهم الطلبة ذوي الإعاقة والاحتياجات التعليمية.' },
            { id: 3,  domain: 'النمو الشخصي',                 standard: 'مهارات التعلم',          title: 'تطبيق مهارات التعلم (الذاتي - التعاوني - الرقمي - التفكير العليا) وربطها بالواقع.' },
            { id: 4,  domain: 'النمو الشخصي',                 standard: 'القيم والسلوك',          title: 'تمسك الطلبة بالهوية العمانية والقيم الإنسانية.' },
            { id: 5,  domain: 'مناخ المدرسة وبيئة التعلم',    standard: 'جودة بيئة التعلم',       title: 'متابعة جوانب الأمن والسلامة والنظافة في بيئة التعلم.' },
            { id: 6,  domain: 'مناخ المدرسة وبيئة التعلم',    standard: 'تخطيط المنهاج الدراسي',  title: 'تخطيط المنهاج الدراسي لتحقيق نواتج التعلم.' },
            { id: 7,  domain: 'مناخ المدرسة وبيئة التعلم',    standard: 'إدارة الصف',             title: 'فاعلية الإدارة الصفية.' },
            { id: 8,  domain: 'التدريس والتقويم',             standard: 'فاعلية التدريس',         title: 'توظيف استراتيجيات التدريس الفعالة.' },
            { id: 9,  domain: 'التدريس والتقويم',             standard: 'فاعلية التدريس',         title: 'تفعيل المصادر والموارد التعليمية.' },
            { id: 10, domain: 'التدريس والتقويم',             standard: 'التقويم ومساندة التقدم', title: 'توظيف أساليب تقويم متنوعة.' },
            { id: 11, domain: 'القيادة والإدارة والحوكمة',    standard: 'القيادة',                title: 'توظيف التقويم الذاتي والتطوير المهني في تحسين الأداء.' },
            { id: 12, domain: 'القيادة والإدارة والحوكمة',    standard: 'القيادة',                title: 'تطبيق السياسات والأنظمة واللوائح المنظمة للعمل.' },
            { id: 13, domain: 'القيادة والإدارة والحوكمة',    standard: 'الحوكمة',                title: 'تنفيذ مبادرات وأنشطة تربوية في المجتمع المدرسي.' }
        ];
