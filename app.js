        ...
        const evidenceBasedContent = {
            ...
            '6': { 
                levels: { 1: "[يخطط المعلم/تخطط المعلمة] لجميع دروسه متسلسلا في تنوع الأهداف مرتبطا بالخطة الفصلية ومحققا لنواتج التعلم بصورة متميزة.", 2: "[يخطط المعلم/تخطط المعلمة] معظم دروسه متسلسلا في تنوع الأهداف مرتبطا بالخطة الفصلية ومحققا لنواتج التعلم بصورة جيدة.", 3: "[يخطط المعلم/تخطط المعلمة] أغلب دروسه متسلسلا في تنوع الأهداف مرتبطا بالخطة الفصلية ومحققا لنواتج التعلم بصورة مناسبة.", 4: "[يخطط المعلم/تخطط المعلمة] قليل دروسه متسلسلا في تنوع الأهداف مرتبطا بالخطة الفصلية ومحققا لنواتج التعلم بصورة محدودة.", 5: "[يخطط المعلم/تخطط المعلمة] عدد محدود جدا دروسه متسلسلا في تنوع الأهداف مرتبطا بالخطة الفصلية ومحققا لنواتج التعلم بصورة نادرة." }, 
            ...
            '7': { 
                levels: { 1: "[يقوم المعلم/تقوم المعلمة] بإدارة زمن التعلم، وسلوك طلبته ويثير دافعيتهم للتعلم بصورة فعالة.", 2: "[يقوم المعلم/تقوم المعلمة] بإدارة زمن التعلم، وسلوك طلبته ويثير دافعيتهم للتعلم بصورة جيدة.", 3: "[يقوم المعلم/تقوم المعلمة] بإدارة زمن التعلم، وسلوك طلبته ويثير دافعيتهم للتعلم بصورة ملائمة.", 4: "[يقوم المعلم/تقوم المعلمة] بإدارة زمن التعلم، وسلوك طلبته ويثير دافعيتهم للتعلم بصورة محدودة.", 5: "[يقوم المعلم/تقوم المعلمة] بإدارة زمن التعلم، وسلوك طلبته ويثير دافعيتهم للتعلم بصورة نادرة." }, 
            ...
            '11': { 
                levels: { 1: "[يجري المعلم/تجري المعلمة] تقويما لأدائه ذاتيا ويوظفه في تحسين تعلم جميع الطلبة بمستوى متميز.", 2: "[يجري المعلم/تجري المعلمة] تقويما لأدائه ذاتيا ويوظفه في تحسين تعلم معظم الطلبة بمستوى فاعل.", 3: "[يجري المعلم/تجري المعلمة] تقويما لأدائه ذاتيا ويوظفه في تحسين تعلم أغلب الطلبة بمستوى مناسب.", 4: "[يجري المعلم/تجري المعلمة] تقويما لأدائه ذاتيا ويوظفه في تحسين تعلم قليل الطلبة بمستوى محدود.", 5: "[يجري المعلم/تجري المعلمة] تقويما لأدائه ذاتيا ويوظفه في تحسين تعلم قليل جدا الطلبة بمستوى نادر." }, 
        ...
        const instructionalRecommendations = {
            ...
            '2': "[تابع/تابعي] التقدم الفردي للطلبة وقدم تحديات مناسبة لمستوياتهم.",
            ...
            '5': "[افحص/افحصي] الملعب والأدوات دورياً وعلم الطلبة قواعد الأمن والسلامة.",
            ...
            '9': "[استغل/استغلي] الموارد المتاحة بشكل إبداعي وكيف الأنشطة مع الإمكانيات.",
            '10': "[استخدم/استخدمي] قوائم الملاحظة لتقديم تغذية راجعة فورية للطلبة.",
            '11': "[تأمل/تأملي] في ممارساتك وابحث عن أفكار جديدة لتطوير أساليبك.",
            '12': "[التزم/التزمي] دائماً باللوائح وكن نموذجاً في السلوك المهني.",
